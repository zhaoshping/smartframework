...
/**
 * @author: zhaoshiping
 * @Date: Created in 10:23 2019/11/12
 * @Description: 请求转发器
 * @Version:
 */
public class DispatcherServlet extends HttpServlet {
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        ...
        aDefault.addMapping(ConfigHelper.getAppJAssetPath()+"*");
    }
    ...
    public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(handler!=null){
            ...
            Object result = ReflectionUtil.invokeMethod(cotrollerBean, actionMethod, param);
            //处理action方法返回值
